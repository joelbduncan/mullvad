...
class SettingsWindow(wx.Frame):
    ...
    def __init__(self, parent, caller, settings):
        ...
        countrynames = {
            'at': _('Austria'),
            'au': _('Australia'),
            'au-mel': _('Australia - Melbourne'),
            'au-syd': _('Australia - Sydney'),
            'au-per': _('Australia - Perth'),
            'be': _('Belgium'),
            'bg': _('Bulgaria'),
            'br': _('Brazil'),
            'ca': _('Canada'),
            ...
            'cz': _('Czech Republic'),
            'de': _('Germany'),
            'de-ber': _('Germany - Berlin'),
            'de-fra': _('Germany - Frankfurt'),
            'dk': _('Denmark'),
            'es': _('Spain'),
            'fi': _('Finland'),
            'fr': _('France'),
            ...
            'gb-cvt': _('United Kingdom - Coventry'),
            'gb-lon': _('United Kingdom - London'),
            'gb-mnc': _('United Kingdom - Manchester'),
            'gr': _('Greece'),
            'hk': _('Hong Kong'),
            'hu': _('Hungary'),
            'il': _('Israel'),
            ...
            'us-dc': _('USA - District of Columbia'),
